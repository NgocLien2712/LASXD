    ...
    <div class="page-a4">
        ...
        <?php if (!empty($danhSachMau)): ?>
            <?php foreach ($danhSachMau as $index => $mau): ?>
                <div class="mb-4">
                    <p class="fw-bold mb-2">Mẫu số <?= $index + 1 ?>: <?= htmlspecialchars($mau['mtn_ten']) ?> (SL: <?= htmlspecialchars($mau['mtn_so_luong']) ?> - <?= htmlspecialchars($mau['mtn_quy_cach'] ?? '......') ?>)</p>
                    ...
                    <?php if (!empty($mau['danh_sach_phep_thu'])): ?>
                        <?php foreach ($mau['danh_sach_phep_thu'] as $pt): ?>
                            ...
                            <table class="table table-tho mb-3 w-100">
                                ...
                                <tbody>
                                    <?php if (!empty($pt['danh_sach_truong'])): ?>
                                        <?php $soCộtĐạiLượng = count($pt['danh_sach_truong']); ?>
        ...
        <div class="row mt-5 text-center justify-content-center">
            <div class="col">
                <h6 class="fw-bold text-uppercase">THÍ NGHIỆM VIÊN</h6>
            ...
            <?php if (!empty($cacDonVi)): ?>
                <?php foreach ($cacDonVi as $dv): ?>
                    <div class="col">
                        <h6 class="fw-bold text-uppercase"><?= htmlspecialchars($dv['vai_tro']) ?></h6>
                        <p class="small fst-italic">(Ký và ghi rõ họ tên)</p>
                        <br><br><br>
                        <p>.......................................</p>
                    </div>
            ...
            <?php else: ?>
                <div class="col">
                    <h6 class="fw-bold text-uppercase">NGƯỜI KIỂM TRA</h6>
                    <p class="small fst-italic">(Ký và ghi rõ họ tên)</p>
                    <br><br><br>
                    <p>.......................................</p>
                </div>
