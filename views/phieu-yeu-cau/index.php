    ...
    <div class="p-4 flex-grow-1 overflow-auto">
        ...
        <div class="bg-white p-4 shadow-sm rounded-3">
            <div class="table-responsive">
                <table class="table table-hover align-middle table-bordered myTable" style="width: 100%; font-size: 0.95rem;">
                    <thead class="table-light text-center">
                        <tr>
                            <th style="width: 10%">Mã Phiếu</th>
                            <th style="width: 25%; min-width: 200px;">Tên Dự Án</th>
                            <th style="width: 20%">Vật liệu thí nghiệm</th>
                            <th style="width: 12%">Người Lập</th>
                    ...
                    <tbody>
                        <?php if (!empty($danhSachGomNhom)): ?>
                            <?php foreach ($danhSachGomNhom as $pyc): ?>
                                <tr>
                                    <td class="text-center"><span class="badge bg-secondary fs-6"><?= htmlspecialchars($pyc['pyc_so_phieu']) ?></span></td>
                                    ...
                                    <td class="text-center"><i class="fas fa-user-circle text-muted me-1"></i> <?= htmlspecialchars($pyc['nv_ten'] ?? 'Ẩn danh') ?></td>
    ...
    $(document).ready(function() {
        ...
        $('.myTable').DataTable({
            language: {
                ...
                "sInfo": "Hiển thị _START_ đến _END_ / _TOTAL_ phiếu",
